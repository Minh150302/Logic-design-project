...
HD_PWD='D:/Study/HDL/ASS/Draft 1/Draft 1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_num7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_num7seg.tcl -notrace
