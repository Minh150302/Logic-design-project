...
HD_PWD='D:/Study/HDL/ASS/Draft 1/Draft 1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_num7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_num7seg.tcl
