module clock_alarm(clk, rst, mode_enb, btn2, btn3, hour1, hour0, min1, min0, sec1, sec0, Alarm);
    ...
    input wire btn2;
    input wire btn3;
    input wire [1:0] hour1;
    input wire [3:0] hour0, min1, min0, sec1, sec0;
    ...
    reg tmp_1s;
    reg clk_1s;
    reg [1:0] a_hour1, c_hour1;
    reg [3:0] a_hour0, a_min1, a_min0, c_hour0, c_min1, c_min0;
    ...
    always @* begin
        ...
        c_hour0 <= tmp_hour - mod_10(tmp_hour);
        c_min1 <= mod_10(tmp_min);
        c_min0 <= tmp_hour - mod_10(tmp_min);
    end
    ...
    assign hour1 = c_hour1;
    assign hour0 = c_hour0;
    assign min1 = c_min1;
    assign min0 = c_min0;
